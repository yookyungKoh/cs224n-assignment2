...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        z = tf.matmul(x, W) + b1
        z = tf.nn.relu(z)
        z_drop = tf.nn.dropout(z, self.dropout_placeholder)
        pred = tf.matmul(z_drop, U) + b2
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        prob = tf.nn.softmax_cross_entropy_with_logits(pred, self.labels_placeholder)
    ...
    def add_training_op(self, loss):
        ...
        """
        ### YOUR CODE HERE
        optimizer = tf.train.AdmaOptimizer(self.config.lr)
